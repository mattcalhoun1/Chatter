...
#define FRAM_CLUSTER_LOC 0x00
#define FRAM_CLUSTER_KEYSIZE CHATTER_DEVICE_ID_SIZE
...
#define FRAM_TRUST_KEYSIZE CHATTER_DEVICE_ID_SIZE
#define FRAM_TRUST_DATASIZE ENC_PUB_KEY_SIZE+CHATTER_ALIAS_NAME_SIZE
#define FRAM_TRUST_ENCRYPTED false
#define FRAM_TRUST_VOLATILE false
#define FRAM_TRUST_SLOTS 20
...
class FramData {
  ...
  protected:
    ...
    uint16_t zoneLocations[FRAM_NUM_ZONES] = { FRAM_CLUSTER_LOC, FRAM_TRUST_LOC, FRAM_PACKET_LOC };
    uint8_t zoneKeySizes[FRAM_NUM_ZONES] = { FRAM_CLUSTER_KEYSIZE, FRAM_TRUST_KEYSIZE, FRAM_PACKET_KEYSIZE };
    uint8_t zoneSlots[FRAM_NUM_ZONES] = { FRAM_CLUSTER_SLOTS, FRAM_TRUST_SLOTS, FRAM_PACKET_SLOTS };
    uint8_t zoneDataSizes[FRAM_NUM_ZONES] = { FRAM_CLUSTER_DATASIZE, FRAM_TRUST_DATASIZE, FRAM_PACKET_DATASIZE };
    uint8_t zoneEncrypted[FRAM_NUM_ZONES] = { FRAM_CLUSTER_ENCRYPTED, FRAM_TRUST_ENCRYPTED, FRAM_PACKET_ENCRYPTED };
    uint8_t zoneVolatile[FRAM_NUM_ZONES] = { FRAM_CLUSTER_VOLATILE, FRAM_TRUST_VOLATILE, FRAM_PACKET_VOLATILE };
